...
describe('State encoder tests', function () {
  ...
  it('should encode', function () {
    const stateEncoder = proxyquire(path.resolve('./src/handler/state-encoder'), {'base64-url': {encode: function (jsonString) {
  ...
  it('should decode', function () {
    const stateEncoder = proxyquire(path.resolve('./src/handler/state-encoder'), {'base64-url': {decode: function (sourceState) {
